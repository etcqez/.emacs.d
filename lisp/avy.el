...
;;    '(avy-lead-face-0 ((t (:foreground "gold1" :background unspecified))))
;;    '(avy-lead-face-1 ((t (:foreground "gold1" :background unspecified))))
;;    '(avy-lead-face-2 ((t (:foreground "gold1" :background unspecified)))))
